...
// simulate a Clock's second-hand tick interrupt.
function simEnableClockInterrupt()
{
	return setInterval( simClockInterrupt , 1000 );
}
function simClockInterrupt() 
{
	_KernelInterruptQueue.enqueue( new Interrput(CLOCK_IRQ, null) );
}
...
function simDisableClockInterrupt()
{
	clearInterval( clockInterruptId );
}
